...
This is version ES v0.8 (2023-03-04) of the LandingRateMx, FlyWithLua script, A mod of LandingRate.lua, originally written by Dan Berry which includes added VR support by William R Good (SparkerInVR) based on initial work by Erhardma
